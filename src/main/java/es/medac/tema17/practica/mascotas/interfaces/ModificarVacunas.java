 ...
 * @author Andrés
 */
public class ModificarVacunas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("MODIFICADOR DE VACUNAS ");
        jLabel2.setOpaque(true);
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 350, 50));
    ...
    private void jButtonInsertarPesoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInsertarPesoActionPerformed
        ...
        jTextArea1.setText("Ha modificado lo siguiente: " + informe);

        try {

            con1.modificarVacunas(IdMascota, FechaActual, Enfermedad, FechaProxima);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarVacunas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarVacunas().setVisible(true);
            }
        });
    }
