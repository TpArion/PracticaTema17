 ...
 * @author Andrés
 */
public class InsertarPesos extends javax.swing.JFrame {

    /**
     * Creates new form InsertarPesos
     */
    public InsertarPesos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("INSERCCIÓN DE PESOS\n");
        jLabel2.setOpaque(true);
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 270, 50));
    ...
    private void jButtonInsertarPesoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInsertarPesoActionPerformed
        ...
        String informe = p1.imprimir();
        jTextArea1.setText("Ha insertado lo siguiente: " + informe);

        try {

            con1.insertarPesos(IdMascota, FechaActual, Peso);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertarPesos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertarPesos().setVisible(true);
            }
        });
    }
